...
implementer needs nothing else — in particular, no source outside this repository.
...
host application, no web framework, no MCP SDK, no JSON Schema
validator. `tests/test_purity.py` proves this at the AST level and by
